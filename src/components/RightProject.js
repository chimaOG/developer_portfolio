...
const RightProject = ({projectDetails : {name, technologies, description, gitLink, projLink, imgLink}}) => {
        ...
        <div className = 'relative mt-28'>
            <div className = {`relative w-full flex`}>
                ...
                />
                    ...
                    <div className='hidden md:flex  highlight h-full w-7/12  absolute top-0 right-0 hover:bg-transparent bg-light_green opacity-50 rounded-lg' >
                    </div>
                </a>
            </div>
            <div className = 'absolute top-0 left-0 p-5 md:p-0 w-full md:w-1/2   h-80 md:h-full flex flex-col items-start md:items-start bg-slate-900/75 md:bg-transparent'>
                ...
                <div className = 'mt-2 md:mt-5 flex justify-end items-center text-title_colors text-sm md:text-base'>
