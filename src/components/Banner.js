...
const Banner = () => {
    return (
        <div className='my-18 sm:my-36'>
            ...
            <p className = 'text-banner_grey text-5xl mt-7 w-5/6 xl:w-5/5 lg:w-4/6'>Full stack web developer, computer vision engineer.</p>

            <p className = 'text-banner_grey text-base mt-10 w-5/6 md:w-4/6  '>
